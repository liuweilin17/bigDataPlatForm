...
<body>
		...
		<ul class="nav nav-stacked" role="tablist">
	      <li role="presentation" class="active"><a href="#addPage" id="add-tab" role="tab" data-toggle="tab" aria-controls="addPage" aria-expanded="true">添加设备</a></li>
	      <li role="presentation"><a href="#searchPage" role="tab" id="search-tab" data-toggle="tab" aria-controls="searchPage">查看设备</a></li>
	      <li role="presentation"><a href="#deletePage" role="tab" id="delete-tab" data-toggle="tab" aria-controls="deletePage">删除设备</a></li>
	      <li role="presentation"><a href="#modifyPage" role="tab" id="modify-tab" data-toggle="tab" aria-controls="modifyPage">修改设备</a></li>
	    </ul>
    </div>
    <div class="col-md-10">
